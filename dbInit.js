...
sequelize.sync({ force }).then(async () => {
    ...
    SpecialisationValues.upsert({name: 'The Blasphemous Nechrubel Bible', description: 'So intensely blasphemous that even the Priests themselves can only peruse it once per day. When read, roll a die. Even result: For the rest of the day PCs heal d4 HP after ust five minutes of rest. Odd result: The priest is plagued by hallucinations. The DM may invent d3 things that only the Priest can see and describe them to the player as if true. This effect ends with sunrise.', class_roll: 5, roll: 4}),
