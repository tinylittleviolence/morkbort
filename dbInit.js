...
sequelize.sync({ force }).then(async () => {
    ...
    ItemValues.upsert({ name: 'Medicine box', flavour_text: 'Stops bleeding/infection and +d6 HP. Presence + 4 uses', value: 15, size: 'Normal', class_affinity: 0, class_roll: 0, starter_table: 2, starter_roll: 7,  is_scroll: 0, custom_flavour_text: 1}),
    ...
    ItemValues.upsert({ name: 'Necklace', flavour_text: 'Made from 49 human teeth.', value: 0, size: 'Normal', class_affinity: 0, class_roll: 0, starter_table: 0, starter_roll: 0,  is_scroll: 0, custom_flavour_text: 1}),
    ...
    ScrollValues.upsert({name: 'Grace for a Sinner', effect: 'A creature of your choice gets +d6 on one roll (damage, test etc.)', scroll_type: 'Sacred', roll: 2}),
   ...
   //lore
   LoreValues.upsert({ tag: 'world', description: 'Distances shift. Paths between places warp. As if this pale, lightless world possessed a will and bitter life. Its mercy curdled to wrath over a too-long age. No one has seen the sun in years. The old care more for sacrifice and god-offerings than their bawling spawn. Doomsayers are proved right time and again and embraced by hidden powers. Maybe it\'s best to surrender - to trust your own instinct and skill rather than the whim of the dice?'}),
   LoreValues.upsert({ tag: 'basilisk', description: 'The Basilisks are two and two-headed. The four heads have argued for hundreds of years.'}),
   LoreValues.upsert({ tag: 'anuk schleger', description: 'Monk of the Creton order, encountered the basilisk Verhu in the year 565 and set down the creature\'s prophecies.'}),
   LoreValues.upsert({ tag: 'verhu', description: 'Verhu predicts inexorable annihilation and, since he\'s always right, has become utterly full of himself. His is also the head worshipped most. If you could learn the codes of the apocalypse perhaps the right offerings might avert it? Verhu loves his position and hungers for temples to be raised in his name.'}),
   LoreValues.upsert({ tag: 'she', description: 'When the world was but water, dust and clouds thick with plague-fat flies came SHE, first of the basilisks. From the cracks of Bergen Chrypt SHE crawled. SHE bears the head of *Denial*, Lusi, who looks up and down. Yet all shall be well. Her twin Arkh, Head of *Deception*, claims to be the first prophet of truths now prostituted by Verhu. Few have ever seen her, the oldest, but many walk her twin paths.'}),
   LoreValues.upsert({ tag: 'he', description: 'SHE spawned many since the dawn of time, their conceptions not without agnoy. All were cast down the cliffs of Bergen Chrypt, only HE survived. Down in the Valley of the Unfortunate Undead his eyes locked upon the mountain peak, HE spits out curses upon his evil mother. The head Gorgh is *bitter, rank with envy* that only his twin Verhu knows the *damned truth*.'}),
   LoreValues.upsert({ tag: 'bergen chrypt', description: 'To the west. Catacombs and ice-caked peaks.'}),
   LoreValues.upsert({ tag: 'endless sea', description: 'Surrounds the known world to the north, south and east. Many have ploughed the wave\'s furrow in search of new lands. They all return, against their will. Alive or dead.'}),
   LoreValues.upsert({ tag: 'galgenbeck', description: 'In the land of Tveland, the greatest city that ever was. No King or Queen rules in Galgenbeck but an arch-priestess: Josilfa Migol.'}),
   LoreValues.upsert({ tag: 'josilfa migol', description: 'Deep beneath the Cathedral of the Two-Headed Basilisks, in a cool black chamber crossed by shards of light, lies her throne. Josilfa, old but still young, commoners gossip that she communes with the god Nechrubel, who gave her eternal life.'}),
   LoreValues.upsert({ tag: 'nechrubel', description: 'The shadow that covers all. Nechrubel is melancholy, crop failure, conflict and war. It is said he whispered the apocalyptic prophecies in Verhu\'s ear.'}),
   LoreValues.upsert({ tag: 'sarkash', description: 'In Tveland also lies Sarkash. The forest seems, lately, to spread unnaturally fast. Paths tangle and wind in the evergrown gloom, leading wanderers astray.'}),
   LoreValues.upsert({ tag: 'graven-tosk', description: 'Far in the depths of Sarkash, always where one least expects to find it, in a halo of dying trees, is Graven-Tosk. A truly ancient cemetary filled with mausoleums, blank-eyed cherubs, stagnant fountains plague pits and ordinary graves. But hasn\'t it grown warmer in this usually cold place? Do you hear the frantic scratching? The air feels heavy, stale and hard to breathe.'}),
   LoreValues.upsert({ tag: 'palace of the shadow king', description: 'Rising over Graven-Tosk like rage rising over pain is the Palace of the Shadow King. A gothic black castle, like a mirror to the Cathedral of the Two-Headed Basilisk in Galgenbeck. Most of the palace lies in crumbling ruins, home to unfortunate souls sheltering beneath its broken halls. None dare dream what might lie under the rubble covered catacombs and cellars. Tunnels sprawl beneath like writhing roots, digging deeper into the cold earth like cancerous veins. The inner wing still stands, acting as the home of the Shadow King.'}),
   LoreValues.upsert({ tag: 'shadow king', description: 'A being obscred by ritual. The slaves of the servants of the courtiers of the King come forth to do his will. The title is hereditary; sons are always born to the Shadow King. It\'s whispered Princes of that line disguise themselves as ordinary men wandering the ruins engaging in games and tricking travelers, multiplying the miseries of their people.'}),
   LoreValues.upsert({ tag: 'grift', description: 'From ages past, Grift grew upon the eastern peninsula of the Endless Sea. Cut from the world by the bottomless Múr, the thriving city state can be reached only by three bridges of such might and cyclopean size it is said that only enslaved giants could have raised them. \n\nGrift was once a place of harmony and the light of reason, a shelter from the plague-wracked, war-torn world beyond. But the world turns and even the Múr cannot protect Grift from its inevitable fall. \n\nKing Sigfrúm the Kind is mocked in the street. Much of Grift has fallen into disrepair as vile creatures begin crawling from the dried, cracked earth. Each night the bridges scream and roar like great ships grinding upon rocks.'}),
   LoreValues.upsert({ tag: 'king sigfrum the kind', description: 'Sigfrúm is defeated. He knows the end is near, believes the prophecies of Verhu and so, kindly and calmly, prepares his people for death. Huge parchments dot the streets, calendars of despair marking each correct preparation and its time. Each day a leaf is turned and when the last page comes, Sigfrúm will march his people to the cliff Terion to fulfill what was written.'}),
   LoreValues.upsert({ tag: 'terion', description: 'A thousand metres of vertical rock with the raging sea biting at its base.'}),
   LoreValues.upsert({ tag: 'kergus', description: 'Desolation rolls over Kergüs like a frost-barren wind. The lawless and forlorn trek across its ice-wracked expanse, crawling over the plains or cowering in the cracked earth to flee the Blood-Countess ANTHELIA.'}),
   LoreValues.upsert({ tag: 'allians', description: 'North, where the wind is born, likes Alliáns, a storm-piercing spire-city of black glass. Within stands a castle like a waterfall of white stone: the throne of Anthelia.'}),
   LoreValues.upsert({ tag: 'anthelia', description: 'She as pale as her castle\'s walls, s youthful as a drop of melting ice. Some say she is eternally young. The gulls cry the names of Knights who sought her hand, a reminder that suitors and signs of Anthelia\'s age disappear in conjunction. But who listens to a gull? And in Kergüs, even gulls freeze in the cold that rolls from the dreams of the Countess. Dreams of her unending youth.\n\nAnthelia is well aware time is short. Neuroses burden her. *"Why is everything so pale? So cold?"* She cries out for colour or warmth. She drains the world of both with every glance, touch and breath. Those who bring her vibrant life are promised great rewards. All fear to do so. Excuses are made, explanations are found. The feelings of the Countess are fraglie, her powers absolute. Court life entails grey opulence, excitement and fear.'}),
   LoreValues.upsert({ tag: 'wastland', description: 'The Western Kingdon, called Wästland in the songs of the simple rhymes of the poor, once home to peace and wealth when Lake Onda gifted fish and the river-trade thrived. Now, terror and despotism stalk. In the secret citadel of the sad-but gaudy city of Schleswig King Fathmu IX schemes.'}),
   LoreValues.upsert({ tag: 'schleswig', description: 'A sad-but-gaudy city in Wästland.'}),
   LoreValues.upsert({ tag: 'king fathmu ix', description: 'Paranoid, fat and increasingly mad, he is consumed with psychosis and invisible fears. Obsessed with the prophecies of Verhu, the King raids and invades houses and villages, barns and temples. Nowhere and no one is safe, especially the poor. Taxed into starvation, the contents of their larders and storehouses are carried off by Fathmu\'s men.'}),
   LoreValues.upsert({ tag: 'valley of the unfortunate undead', description: 'A place few wish to speak of. Rumours whisper the Basilisk HE is coiled within its crypts, a sight infrequently survived. Lies and legends enshroud the valley, obscuring any truth. Peddler\'s tales say the soil, the very air, is lethal - bringing a sleepless, stumbling death. This is no clean fate but a slow-growing, fathomless despair, weighing down the traveler with poisoned memories and dark thoughts until the spark of life is mutated into a mournful, hopeless undeath.\n\nOthers claim lost wanderers can fall and find themselves in the Realm of the Dead when the black soil hungrily drags them under the earth.\n\nThose without hope travel here seeking an end to pain, a golden afterlife beyond this dark and ruined world. They gather in suicide cults and the valley\'s few twisted trees begin to droop strange fruit from hempen rope. Others plumb the crypts seeking Verhu, believing they can persuade him of other fates. Some simply and stupidly leave gifts and sacrifices to a power they cannot comprehend. Gloom grows, obscuring the world like an oil-stained image.'}),
